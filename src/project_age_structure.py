...
OUTPUT_FILE = OUTPUT_DIR / "city_age_projection_2020_2035.xlsx"
...
if __name__ == "__main__":
    try:
        ...
        print("-" * 30)
        print("2020-2035 city age-structure projection complete.")
        print(f"Total rows: {len(final_df)}")
        print(f"City count: {final_df['市代码'].nunique()}")
