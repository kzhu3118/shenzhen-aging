...
# =========================
# 6. Per-raster processing function.
# =========================
def process_one_tif(tif):
...
# =========================
long_results = Parallel(n_jobs=N_JOBS, backend="loky")(
    delayed(process_one_tif)(tif) for tif in tif_files
)

long_df = pd.concat(long_results, ignore_index=True)

# =========================
# 8. Build the wide table.
# =========================
...
# =========================
# 9. Sort wide-table columns by age.
# =========================
